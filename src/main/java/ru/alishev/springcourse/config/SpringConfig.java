...
public class SpringConfig implements WebMvcConfigurer {
    ...
    private final Environment env; // с помощью этого сможем использовать файл hibernate.properties
...
//    }
    ...
    // Для смены с голого Hibernate на sping data jpa мы поменяли: session на entityManager, sessionFactory на
    // entityManagerFactory и hibernateTransactionManager на JpaTransactionManager. Поменяли методы Hibernate на JPA
    @Bean
